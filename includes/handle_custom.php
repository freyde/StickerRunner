...
if (isset($_SESSION["userEmailAdd"])) {
    $email_add = $_SESSION["userEmailAdd"];
    ...
    if (isset($_POST['scope'])) {
        ...
        switch ($scope) {
            ...
            case "delete":
                ...
                $delete_query = "DELETE FROM `custom_shirt` WHERE custom_id = '$item_code'";
    ...
    if (isset($_POST["item_id"])) {
        ...
        foreach ($_POST["item_id"] as $item_id) {
            $fetch_price = "SELECT * FROM `custom_shirt` WHERE custom_id = '$item_id' ";
    ...
    if (isset($_POST["check_id"])) {
        foreach ($_POST["check_id"] as $check_id) {
            $select = "SELECT * FROM `custom_shirt` WHERE custom_id = '$check_id'";
