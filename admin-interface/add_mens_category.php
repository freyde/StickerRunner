...
if(isset($_POST["addCategorybtn"])){
    ...
    $select_query = "SELECT * FROM `mens_categories` WHERE mens_category_name = '$category_name'";
    ...
    if($numberOfRow>0){
        ...
        $insert_query = "INSERT INTO `mens_categories` (mens_category_name) VALUES ('Mens $category_name')";
...
<body>
    <div class="container shadow-lg bg-white" style="border: 1px solid orangered; margin-top: 50px;">
        <h1 class="text-center pt-3 pb-3 bg-warning">Add Men's Category</h1>
