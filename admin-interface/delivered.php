...
<body>
    <div class="container shadow-lg bg-white" style="margin-top: 50px; width:100%;">
        ...
        <ul class="nav nav-tabs nav-fill">
            ...
            <li class="nav-item">
                <a class="nav-link" href="main_dashboard.php?delivered"><strong><u>Delivered</u></strong></a>
            </li>
            <li class="nav-item">
    ...
    <div class="list-of-products">
        <?php
        $select_list = mysqli_query($conn, "SELECT * FROM orders WHERE order_status='Delivered' ORDER BY order_date DESC");
        ?>
        ...
        <table class="table table-bordered table-striped border-primary table-hover">
            ...
            ?>
        </table><table class="table table-bordered table-striped border-primary table-hover" id="orderTable">
                    <thead class="text-center fw-bold">
                        <th>Package Number</th>
                        <th>Customer Email</th>
                        <!-- <th>Item Code</th> -->
