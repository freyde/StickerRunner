...
<body>
    <div class="container shadow-lg bg-white" style="margin-top: 50px; width:100%;">
        ...
        <ul class="nav nav-tabs nav-fill">
            ...
            <li class="nav-item">
                <a class="nav-link" href="main_dashboard.php?in_transit"><strong><u>In-Transit</u></strong></a>
            </li>
            <li class="nav-item">
    ...
    <div class="list-of-products">
        <?php
        $select_list = mysqli_query($conn, "SELECT * FROM orders WHERE order_status='In Transit' ORDER BY order_date DESC");
        ?>
